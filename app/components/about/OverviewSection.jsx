...
import ideaImage from '../../resources/images/project/idea.png';
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="mt-4 flex-grow">
            <p className="text-base sm:text-lg tracking-wide leading-relaxed mb-4">
              Namaste!🙏 This is more than a portfolio; it's a window
        ...
        <motion.div
          className="p-4 sm:p-6 md:p-8 border min-h-[200px] border-[#333] bg-[#111111] rounded-3xl relative overflow-hidden shadow-2xl"
          transition={{ type: "spring", stiffness: 300 }}
        >
          ...
          >
            ...
            <motion.a
              href="https://bitbugflex.vercel.app/"
              target="_blank"
              ...
              whileTap={{ scale: 0.95 }}
            >
              bitbugflex <LuExternalLink className="ml-1 w-4 h-4" />
            </motion.a>
          </motion.div>
        </motion.div>
      </div>
