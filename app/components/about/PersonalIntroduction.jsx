          ...
          >
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-4 sm:p-6 text-white">
              ...
              <p className="mt-3 sm:mt-4 text-base sm:text-lg font-light leading-relaxed">
                Empowering Ideas Through Code and Creativity: Turning bold visions into seamless experiences, where technology amplifies imagination and drives meaningful impact.
              </p>
              <p className="mt-4 sm:mt-6 text-base sm:text-lg italic">
                Build fearlessly, innovate endlessly. 🚀
              </p>
            </div>
          </motion.div>
        </div>
